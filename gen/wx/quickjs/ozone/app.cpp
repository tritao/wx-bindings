    ...
    int argc, JSValueConst* argv)
{
    ...
    Ozone::AppConsole* instance = (Ozone::AppConsole*) JS_GetOpaque(this_val, classId_Ozone_AppConsole);
    ...
    int argc, JSValueConst* argv)
{
    ...
    Ozone::App* instance = (Ozone::App*) JS_GetOpaque(this_val, classId_Ozone_App);
