    ...
    int argc, JSValueConst* argv)
{
    ...
    Ozone::FontMetrics* instance = (Ozone::FontMetrics*) JS_GetOpaque(this_val, classId_Ozone_FontMetrics);
    ...
    int argc, JSValueConst* argv)
{
    ...
    Ozone::DC* instance = (Ozone::DC*) JS_GetOpaque(this_val, classId_Ozone_DC);
