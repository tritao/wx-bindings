...
enum class DataFormatId : unsigned int
{
    INVALID = 0,
    TEXT = 1,
    BITMAP = 2,
...
enum class GeometryCentre : unsigned int
{
    CENTRE = 0x1,
    CENTER = 1
};
...
enum class SizerFlagBits : unsigned int
{
...
enum class Stretch : unsigned int
{
    STRETCH_NOT = 0x0,
    SHRINK = 0x1000,
    GROW = 0x2000,
