    ...
    int argc, JSValueConst* argv)
{
    ...
    Ozone::Frame* instance = (Ozone::Frame*) JS_GetOpaque(this_val, classId_Ozone_Frame);
...
overload0:
    {
        ...
        auto __arg0 = text;
        int number;
        if (JS_ToInt32(ctx, (int32_t*) &number, argv[1]))
            return JS_EXCEPTION;
...
overload0:
    {
        int number;
        if (JS_ToInt32(ctx, (int32_t*) &number, argv[0]))
            return JS_EXCEPTION;
