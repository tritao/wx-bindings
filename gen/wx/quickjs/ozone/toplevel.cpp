...
static void register_enum_Ozone_FrameStyle(JSContext *ctx, JSModuleDef *m, bool set)
{
    ...
    // TINY_CAPTION
    {
        ...
        JS_SetPropertyStr(ctx, val, "TINY_CAPTION", __item);
    }
    ...
    // ICONIZE
    {
        JSValue __item = JS_NewInt32(ctx, 16384);
        JS_SetPropertyStr(ctx, val, "ICONIZE", __item);
    }
...
struct data_Ozone_TopLevelWindow : public JS_Interop_ClassData
{
...
JSValue callback_event_getter_Ozone_TopLevelWindow_OnMaximize(JSContext *ctx, JSValueConst this_val)
{
    ...
    ((Ozone::TopLevelWindow*)data->instance)->OnMaximize.bind(data, &data_Ozone_TopLevelWindow::event_invoke_OnMaximize);
...
JSValue callback_event_getter_Ozone_TopLevelWindow_OnMove(JSContext *ctx, JSValueConst this_val)
{
    ...
    ((Ozone::TopLevelWindow*)data->instance)->OnMove.bind(data, &data_Ozone_TopLevelWindow::event_invoke_OnMove);
...
JSValue callback_event_getter_Ozone_TopLevelWindow_OnMoveStart(JSContext *ctx, JSValueConst this_val)
{
    ...
    ((Ozone::TopLevelWindow*)data->instance)->OnMoveStart.bind(data, &data_Ozone_TopLevelWindow::event_invoke_OnMoveStart);
...
JSValue callback_event_getter_Ozone_TopLevelWindow_OnMoveEnd(JSContext *ctx, JSValueConst this_val)
{
    ...
    ((Ozone::TopLevelWindow*)data->instance)->OnMoveEnd.bind(data, &data_Ozone_TopLevelWindow::event_invoke_OnMoveEnd);
...
JSValue callback_event_getter_Ozone_TopLevelWindow_OnShow(JSContext *ctx, JSValueConst this_val)
{
    ...
    ((Ozone::TopLevelWindow*)data->instance)->OnShow.bind(data, &data_Ozone_TopLevelWindow::event_invoke_OnShow);
...
overload1:
    {
        ...
        auto __arg2 = title;
        Ozone::Point* pos_instance = (Ozone::Point*) JS_Interop_GetInstance(argv[3], classId_Ozone_Point, JS_INTEROP_INSTANCE_RAW_POINTER);

        auto &__arg3 = *pos_instance;
        Ozone::Size* size_instance = (Ozone::Size*) JS_Interop_GetInstance(argv[4], classId_Ozone_Size, JS_INTEROP_INSTANCE_RAW_POINTER);
...
overload0:
    {
        unsigned int kind;
        uint32_t _kind;
        if (JS_ToUint32(ctx, &_kind, argv[0]))
            return JS_EXCEPTION;
        kind = (unsigned int)_kind;
