    ...
    int argc, JSValueConst* argv)
{
    ...
    Ozone::TopLevelWindow* instance = (Ozone::TopLevelWindow*) JS_GetOpaque(this_val, classId_Ozone_TopLevelWindow);
...
// Ozone::TopLevelWindow::OnActivate
static JSValue callback_method_Ozone_TopLevelWindow_OnActivate(JSContext* ctx, JSValueConst this_val,
    int argc, JSValueConst* argv)
{
    if (argc < 1 || argc > 1)
    {
...
overload0:
    {
        Ozone::ActivateEvent* _0_instance = (Ozone::ActivateEvent*) JS_GetOpaque(argv[0], classId_Ozone_ActivateEvent);
...
static JSCFunctionListEntry funcDef_Ozone_TopLevelWindow[]
{
    ...
    JS_CFUNC_DEF("OnActivate", 1, callback_method_Ozone_TopLevelWindow_OnActivate),
